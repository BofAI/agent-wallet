"""Tests for EvmAdapter — comprehensive sign/verify roundtrip."""
...
@pytest.fixture
def evm_wallet():
    return EvmAdapter(private_key=TEST_KEY)
...
async def test_get_address_checksum():
    ...
    key = os.urandom(32)
    wallet = EvmAdapter(private_key=key)
...
async def test_different_keys_different_signatures():
    ...
    wallet_a = EvmAdapter(private_key=os.urandom(32))
    wallet_b = EvmAdapter(private_key=os.urandom(32))
